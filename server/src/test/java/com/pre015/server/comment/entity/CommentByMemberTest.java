...
public class CommentByMemberTest {
    ...
    @Test
    @DisplayName("get Comment Page By Member")
    void getPageComment() throws Exception {
        ...
        BDDMockito.given(commentService.findCommentsByMember(
        ...
        ResultActions actions = mockMvc.perform(RestDocumentationRequestBuilders.get("/comments/member/{member_id}", memberId)
                .param("page","1")
                .param("size","3")
        ...
        actions.andExpect(MockMvcResultMatchers.status().isOk())
                ...
                .andDo(MockMvcRestDocumentation.document("getCommentsByMember",
                        Preprocessors.preprocessRequest(Preprocessors.prettyPrint()),
                        Preprocessors.preprocessResponse(Preprocessors.prettyPrint()),
                        RequestDocumentation.pathParameters(
                                RequestDocumentation.parameterWithName("member_id").description("회원 식별자")
                        ),
