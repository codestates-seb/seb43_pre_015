    ...
    return (
        <SidebarContainer>
            <ol className='sidebar-main-list'>
                <li 
                    className={`sidebar-home ${selectedItem === 'home' ?  'selected' : ''}`} 
                ...
                <ol className='sidebar-sub-list'>
                    <li 
                        className={`sidebar-questions ${selectedItem === 'questions' ? 'selected' : ''}`}
                        onClick={() => handleItemClick('questions')}
                    >
                        <span className="material-symbols-outlined">public</span>Questions
                    </li>
                    <li 
                        className={`sidebar-user ${selectedItem === 'user' ? 'selected' : ''}`}
